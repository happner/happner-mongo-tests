describe('basic - shared data component', function () {
  ...
  context('direct use', function () {
    ...
    it('should subscribe and get an initial value on the callback', function (callback) {
      ...
      var basePath = '/b7/testsubscribe/data/value_on_callback_test/' + testId;

      dataComponent.set(basePath, {"test": "data"}, function (e) {
        if (e) return callback(e);

        dataComponent.on(basePath, {
          "event_type": "set",
    ...
    it('should subscribe and get initial values on the callback', function (callback) {
      ...
      dataComponent.set(basePath + '/1', {"test": "data"}, function (e) {
        if (e) return callback(e);

        dataComponent.set(basePath + '/2', {"test": "data1"}, function (e) {
          if (e) return callback(e);
